...
ENTITY Ram IS
	...
	(
		...
		data		: IN STD_LOGIC_VECTOR (Row_Bits - 1 DOWNTO 0);
		wren		: IN STD_LOGIC ;
		q		: OUT STD_LOGIC_VECTOR (Row_Bits - 1 DOWNTO 0)
	);
END Ram;
...
ARCHITECTURE SYN OF ram IS
	...
	SIGNAL sub_wire0	: STD_LOGIC_VECTOR (Row_Bits - 1 DOWNTO 0);
	...
	GENERIC MAP (
		...
		clock_enable_output_a => "BYPASS",
	        intended_device_family => "Cyclone IV E",
                lpm_hint => "ENABLE_RUNTIME_MOD=YES,INSTANCE_NAME="& Colour_Ram,
		lpm_type => "altsyncram",
		numwords_a => Image_Height,
...
-- Retrieval info: PRIVATE: JTAG_ID STRING "Init"
...
-- Retrieval info: CONSTANT: LPM_HINT STRING "ENABLE_RUNTIME_MOD=YES,INSTANCE_NAME=Init"
